...
import io.core9.proxy.Core9HostResolver;
...
public class DefaultHttpProxyServer implements HttpProxyServer {
    ...
    private static class DefaultHttpProxyServerBootstrap implements
        ...
        private HostResolver serverResolver = new Core9HostResolver();
        ...
        public HttpProxyServerBootstrap withUseDnsSec(boolean useDnsSec) {
        	throw new UnsupportedOperationException("Not supported in core9 fork");
        }
